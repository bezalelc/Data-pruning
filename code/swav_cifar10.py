...
classes = 10
FEATURES = 512  # 512
save_to = os.path.join(DIR_ROOT_SAVE, f'swav_cifar10_{FEATURES}_1')
...
path_to_train = "../datasets/cifar10images/train/"
path_to_test = "../datasets/cifar10images/test/"
...
if __name__ == '__main__':
    ...
    logger = TensorBoardLogger(save_dir=os.path.join(logs_root_dir, "cifar10"), name="", sub_dir=sub_dir,
    ...
    swav.eval()
    features = np.empty((50000, FEATURES))
    labels = np.empty((50000,), dtype=int)
    n = 0
