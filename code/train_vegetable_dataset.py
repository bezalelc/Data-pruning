# this file contains common code for run the experiments in the notebooks:
# model for run vegetable dataset with scheduler and optimizer
...
# simple and fast model for get metrics
...
# helper for train model for vegetable dataset and save the results in files
class ModelManager:
